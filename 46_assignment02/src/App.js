      ...
      <nav class="navbar fixed navbar-expand-md navbar-light bg-white shadow py-2">
        <div className="container-fluid">
            <input className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg
              ...
              dark:focus:ring-blue-500 dark:focus:border-blue-500" type="search" value={query} placeholder="Search" aria-label="Search" onChange={handleChange}/>
            <button type="button" class="btn btn-primary justify-content-end align-middle" onClick={updateHooks}>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-cart float-left align-middle" viewBox="0 0 16 16">
